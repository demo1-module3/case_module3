<%@ page import="org.example.bai_case_module3.entity.Bill" %>
...
<% List<Bill> billDetails = (List<Bill>) request.getAttribute("bills"); %>
<html>
<head>
...
<table>
    ...
    <c:forEach items="${bills}" var="bills">
        <tr>
            <td>${i}</td>
            <td>${bills.userId.fullName}</td>
            <td><fmt:formatNumber value="${bills.totalAmount}" pattern="#,##0"/></td>
